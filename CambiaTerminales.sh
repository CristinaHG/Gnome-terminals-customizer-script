...
#toma aleatoriamente otra imágen para el desktop 
...
$GCONFT --set /apps/gnome-terminal/profiles/Default/use_custom_command --type bool "true" #false por defecto
...
#2) los ordenamos por valor numérico del string
